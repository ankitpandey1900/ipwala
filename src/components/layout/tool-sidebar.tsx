...
export function ToolSidebar({ onSelectTool }: ToolSidebarProps) {
  return (
    <aside className="hidden lg:flex flex-col w-56 border-r border-border/50 bg-card/30 p-3 gap-1">
      <h2 className="text-xs font-mono font-semibold text-muted-foreground uppercase tracking-wider px-2 mb-2">
        Tools
      </h2>
      {TOOLS.map((tool) => {
        ...
        return (
          <button
            ...
            className="flex items-center gap-2.5 px-2.5 py-2 rounded-md text-sm font-mono text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors text-left group"
          >
